...
if (!isNode) {
  ...
  function updateModeButtons() {
    document
      ...
      .classList.toggle("selected", displayMode === "list");
    document
      .getElementById("btnRanges")
      .classList.toggle("selected", displayMode === "ranges");
  }

  function updateFilterButtons() {
    document
      .getElementById("btnOnlyA")
      .classList.toggle("selected", filterMode === "only-a");
    document
      .getElementById("btnInBoth")
      .classList.toggle("selected", filterMode === "in-both");
    document
      .getElementById("btnOnlyB")
      .classList.toggle("selected", filterMode === "only-b");
  }
